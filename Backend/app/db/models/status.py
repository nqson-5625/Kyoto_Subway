...
class LineStatusEvent(Base):
    ...
    event_category: Mapped[str] = mapped_column(Text, nullable=False, server_default=text("'incident'"))
    impact_level: Mapped[str] = mapped_column(Text, nullable=False, server_default=text("'minor'"))
...
class RoutingEdgesCurrent(Base):
    ...
    status_source: Mapped[str] = mapped_column(Text, nullable=False, server_default=text("'normal'"))
