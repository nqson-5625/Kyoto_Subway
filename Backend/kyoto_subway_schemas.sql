...
SELECT
    ...
    seg.from_stop_sequence,
    seg.departure_at,

    seg.to_station_id,
    seg.to_station_name,
    seg.to_stop_sequence,
    seg.arrival_at,
...
SELECT
    d.service_date,
    'transfer'::TEXT AS edge_type,

    NULL::TEXT AS trip_id,
    NULL::TEXT AS line_id,
    NULL::SMALLINT AS direction_id,
    NULL::TEXT AS direction_name,
    NULL::TEXT AS headsign,
...
SELECT DISTINCT ON (
    ...
    pst.scheduled_arrival_time,
    pst.scheduled_arrival_day_offset,
    pst.scheduled_departure_time,
    pst.scheduled_departure_day_offset,

    pst.predicted_arrival_time,
    pst.predicted_arrival_day_offset,
    pst.predicted_departure_time,
    pst.predicted_departure_day_offset,
    pst.predicted_arrival_at,
    pst.predicted_departure_at,

    pst.delay_min,
    pst.status,
    pst.prediction_source
...
SELECT DISTINCT ON (
    ...
    nd.direction_id,
    nd.direction_label,
    nd.line_station_order,
    nd.stop_sequence,
    nd.headsign,

    nd.predicted_departure_time,
    nd.predicted_departure_day_offset,
    nd.predicted_departure_at,
    nd.delay_min,
    nd.status
